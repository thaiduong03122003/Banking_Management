...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("quanlynganhang/icon/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("quanlynganhang/icon/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("quanlynganhang/icon/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("quanlynganhang/icon/light.svg"));
        }
    }
