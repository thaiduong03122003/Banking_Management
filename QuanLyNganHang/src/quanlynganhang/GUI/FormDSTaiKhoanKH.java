...
public class FormDSTaiKhoanKH extends javax.swing.JPanel {
    ...
    public FormDSTaiKhoanKH() {
        ...
        jPTblKhachHang.putClientProperty(FlatClientProperties.STYLE, ""
            + "background:$BodyPanel.background;");
        txtSearchKH.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Nhập mã tài khoản / mã khách hàng cần tìm...");
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã tài khoản", "Số tài khoản", "Số dư", "Mã ngân hàng", "Mã khách hàng sở hữu", "Loại tài khoản", "Trạng thái"
            }
        ));
